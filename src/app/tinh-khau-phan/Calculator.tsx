...
export default function Calculator() {
  ...
  return <div className="calculation-workspace flex flex-col gap-6">
    ...
    <section className={activeView === "entry" ? "clinical-panel rounded-xl border-2 border-[#7f948d] bg-[#f4f8f5] p-6" : "hidden"}>
      ...
      <div className="mt-5 flex flex-col gap-5"><MealInput onRowsChange={setRows} onModeChange={setRationMode} profileSlot={<PersonalProfile onChange={setProfile} inline />} /><NoteBox value={reportMeta.menuNote} onChange={setMenuNote} /></div>
