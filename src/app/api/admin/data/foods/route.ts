...
const select = { id: true, name: true, source: true, sourceCode: true, sourceNote: true, foodType: true, foodGroup: true, wastePercent: true, energyKcal: true, proteinG: true, lipidG: true, glucidG: true, fiberG: true, updatedAt: true };
