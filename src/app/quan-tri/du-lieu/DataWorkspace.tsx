  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-2xl border-2 border-[#0b6957] bg-white p-4 shadow-[0_8px_20px_rgba(18,60,54,.04)] sm:p-5">
        ...
        <h2 className="mt-0.5 text-lg font-semibold text-[#122f2a]">Tải RNI đầy đủ — foods + món ăn kèm nguyên liệu</h2>
        <p className="mt-1 text-sm text-[#506761]">Bản đầy đủ để làm offline: JSON gộp có mọi chỉ số dinh dưỡng + công thức nguyên liệu từng món (foods gồm cả VDD lẫn RNI để nguyên liệu tra được thành phần).</p>
